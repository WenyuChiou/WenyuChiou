<div align="center">
<img width="1200" height="475" alt="Wenyu Chiou — PhD candidate at Lehigh, modeling decision under risk" src="https://github.com/user-attachments/assets/0aa67016-6eaf-458a-adb2-6e31a0763ed6" />
</div>
...
| 🤝 [**agent-collab-skills**](https://github.com/WenyuChiou/agent-collab-skills) | 5 Claude Code skills for multi-agent orchestration — task splitter, output reconciler, debate, shared memory, acceptance gate |
...
- 🏛️ Lehigh: [Catastrophe Modeling & Resilience](https://catastrophe.lehigh.edu/)
